...
<html lang="en">
   ...
   <body>
      <section class="mt-3">
         ...
         <h4 class="text-center" style="color:green"> Timmi Restaurant & Hotel </h4>
                        ...
                        <td style="width:60%">
                           <select name="vegitable" id="vegitable"  class="form-control">
                             <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option id=<?php echo e($row->id); ?> value=<?php echo e($row->product_name); ?> class="vegitable custom-select">
...
<?php /**PATH C:\xampp\htdocs\laravel-bill-receipt-system\resources\views/Bill.blade.php ENDPATH**/ ?>